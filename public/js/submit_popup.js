    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (helpful == "no") {
                ...
                $(".helpfulNoSubmit").html('<p><span style="font-weight: bold;">Product Area:</span><span>' + pa + ',</span><span style="font-weight: bold;">Issue Type:</span><span>' + it + ',</span><span style="font-weight: bold;">Product Family:</span><span>' + pf + ',</span><span style="font-weight: bold;">Product Component:</span><span>' + pc + '</span></p>');
            } else {
                $(".helpfulYesSubmitAlready").hide();
                $(".helpfulYesSubmit").html('<p><span style="font-weight: bold;">Product Area:</span><span>' + pa + ',</span><span style="font-weight: bold;">Issue Type:</span><span>' + it + ',</span><span style="font-weight: bold;">Product Family:</span><span>' + pf + ',</span><span style="font-weight: bold;">Product Component:</span><span>' + pc + '</span></p>');
            }
