...
class PetsittersController extends Controller{
    ...
    public function view_petsitters_candidates(Request $request){
        $data['menu']   = "petsitters";
        $candidate      = FrontUser::where('role', 'petsitters')->get();
        
        if($request->ajax()){
            return DataTables::of($candidate)
                ->addColumn('action', function ($row) {
                    $btn = '<span data-toggle="tooltip" title="Edit Candidate" data-trigger="hover">
                                <a href="'.url('admin/candidates/edit-petsitters/'.$row->id).'" class="btn btn-sm btn-primary edit-candidate" type="button" data-id="' . $row->id . '"><i class="fa fa-pen"></i></a>
                            </span>';
        ...
        return view('admin.petsitters.index', $data);
    }

    public function edit_petsitters_candidate($id){
        $data['menu']                                           = "petsitters";
        ...
        return view('admin.petsitters.edit', $data);
    }
    ...
    public function delete_petsitters_candidate($id){
