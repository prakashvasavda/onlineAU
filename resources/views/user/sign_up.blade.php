            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <ul class="banner-btn-list">
                        <li>
                            <a href="javaScript:;" class="btn btn-light">Au-Pair</a>
                        </li>
                        <li>
                            <a href="javaScript:;" class="btn btn-light">Nanny</a>
                        </li>
                        <li>
                            <a href="javaScript:;" class="btn btn-light">Babysitter</a>
                        </li>
                        <li>
                            <a href="javaScript:;" class="btn btn-light">Pet sitter</a>
                        </li>
                    </ul>
                </div>
            </div>
