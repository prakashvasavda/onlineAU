                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{url('admin/candidates/nannies')}}">{{isset($menu) ? ucwords($menu) : ""}}</a></li>
                ...
                <div class="col-md-12">
                    <div class="card card-secondary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Edit Nanny</h3>
                        </div>

                        {{-- form --}}
                        <form method="POST" id="request_data" action="{{ route('admin.candidates.update-nannies', ['id' => $candidate->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select id="religion" name="religion" class="form-control">
                                                ...
                                                <option value="african traditional and diasporic" {{ isset($candidate->religion) && $candidate->religion == 'african traditional and diasporic' ? 'selected' : null }}>African Traditional &amp; Diasporic</option>                                                <option value="agnostic" {{ isset($candidate->religion) && $candidate->religion == 'agnostic' ? 'selected' : null }}>Agnostic</option>
                            ...
                            <div class="card-footer">
                                <a href="{{ route('admin.candidates.nannies') }}" ><button class="btn btn-default" type="button">Back</button></a>
